          ...
          <ul class="navbar-nav justify-content-end">
              ...
              <li class="nav-item dropdown pe-2 d-flex align-items-center">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end px-2 py-3" aria-labelledby="profileDropdown">
                      <li>
                          <a class="dropdown-item border-radius-md" href="{{ route('admin.profile.show') }}">
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
      // حل مشكلة اختفاء الدروب داون
      const profileDropdown = document.getElementById('profileDropdown');
      const dropdownMenu = document.querySelector('.dropdown-menu[aria-labelledby="profileDropdown"]');
